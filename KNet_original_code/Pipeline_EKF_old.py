...
class Pipeline_EKF:
    ...
    def NNTrain(self, train_input, train_target, cv_input, cv_target, save_model=True):
    ...
    def NNTest(self, test_input, test_target):
        ...
        return [self.MSE_test_linear_arr_total, self.MSE_test_linear_avg_total, self.MSE_test_dB_avg_total,
                self.MSE_test_linear_arr_theta, self.MSE_test_linear_avg_theta, self.MSE_test_dB_avg_theta,
                self.MSE_test_linear_arr_omega, self.MSE_test_linear_avg_omega, self.MSE_test_dB_avg_omega, x_out_array]
